...
class PestoEvalTables {
    private val midGameValue = intArrayOf(82, 337, 365, 477, 1025, 0)
    private val endGameValue = intArrayOf(94, 281, 297, 512, 936, 0)

    private val midGamePawnTable = intArrayOf(
        0, 0, 0, 0, 0, 0, 0, 0,
    ...
    private val endGamePawnTable = intArrayOf(
        0, 0, 0, 0, 0, 0, 0, 0,
        13, 8, 8, 10, 13, 0, 2, -7,
        4, 7, -6, 1, 0, -5, -1, -8,
        13, 9, -3, -7, -7, -8, 3, -1,
    ...
    private val midGameKnightTable = intArrayOf(
    ...
    private val endGameKnightTable = intArrayOf(
    ...
    private val midGameBishopTable = intArrayOf(
    ...
    private val endGameBishopTable = intArrayOf(
        -23, -9, -23, -5, -9, -16, -5, -17,
        -14, -18, -7, -1, 4, -9, -15, -27,
        -12, -3, 8, 10, 13, 3, -7, -15,
        -6, 3, 13, 19, 7, 10, -3, -9,
    ...
    private val midGameRookTable = intArrayOf(
    ...
    private val endGameRookTable = intArrayOf(
        -9, 2, 3, -1, -5, -13, 4, -20,
        -6, -6, 0, 2, -9, -9, -11, -3,
        -4, 0, -5, -1, -7, -12, -8, -16,
        3, 5, 8, 4, -5, -6, -8, -11,
    ...
    private val midGameQueenTable = intArrayOf(
    ...
    private val endGameQueenTable = intArrayOf(
    ...
    private val midGameKingTable = intArrayOf(
    ...
    private val endGameKingTable = intArrayOf(
    ...
    private fun mirrorArray(array: IntArray): IntArray {
        val mirroredArray = IntArray(64)
    ...
    private fun getValue(table: IntArray, idx: Int): Int {
        return table[idx]
    }
